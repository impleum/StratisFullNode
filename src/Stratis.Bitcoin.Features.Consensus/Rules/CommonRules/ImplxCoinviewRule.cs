...
{
    /// <summary>
    /// Implx PoS overrides for certain coinview rule checks.
    /// </summary>
    public sealed class ImplxCoinviewRule : PosCoinviewRule
    {
        ...
        public override void CheckBlockReward(RuleContext context, Money fees, int height, Block block)
        {
            ...
            if (BlockStake.IsProofOfStake(block))
            {
                ...
                foreach (TxOut output in coinstake.Outputs)
                {
                    ...
                    if (output.ScriptPubKey == ImplxCoinstakeRule.CirrusRewardScript)
        ...
        protected override void AllowSpend(TxOut prevOut, Transaction tx)
        {
            ...
            if (prevOut.ScriptPubKey == ImplxCoinstakeRule.CirrusRewardScript)
            {
