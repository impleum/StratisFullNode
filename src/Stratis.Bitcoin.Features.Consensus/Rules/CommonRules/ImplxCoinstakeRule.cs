...
{
    /// <summary>Context checks on a Implx POS block.</summary>
    public class ImplxCoinstakeRule : PartialValidationConsensusRule
    {
        ...
        public override Task RunAsync(RuleContext context)
        {
            ...
            if (BlockStake.IsProofOfStake(block))
            {
                ...
                // TODO: Add proper Implx-specific consensus error
