...
namespace Stratis.Bitcoin.Features.MemoryPool.Rules
{
    ...
    /// </summary>
    public class ImplxCoinViewMempoolRule : CheckCoinViewMempoolRule
    {
        public ImplxCoinViewMempoolRule(Network network,
            ITxMempool mempool,
        ...
        /// <remarks>Also see <see cref="ImplxCoinviewRule"/></remarks>>
        public override void CheckTransaction(MempoolValidationContext context)
        {
            ...
            foreach (TxIn txin in context.Transaction.Inputs)
            {
                ...
                if (unspentOutput.Coins.TxOut.ScriptPubKey == ImplxCoinstakeRule.CirrusRewardScript)
                {
