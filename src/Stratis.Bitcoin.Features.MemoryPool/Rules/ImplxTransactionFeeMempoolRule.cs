...
namespace Stratis.Bitcoin.Features.MemoryPool.Rules
{
    ...
    /// </summary>
    public class ImplxTransactionFeeMempoolRule : CheckFeeMempoolRule
    {
        public ImplxTransactionFeeMempoolRule(Network network,
            ITxMempool mempool,
        ...
        public override void CheckTransaction(MempoolValidationContext context)
        {
            ...
            if (context.Transaction.Outputs.All(o => o.ScriptPubKey != ImplxCoinstakeRule.CirrusTransactionTag(this.network.CirrusRewardDummyAddress)))
            {
