...
{
    public static class ImplxNetwork
    {
        /// <summary> Implx maximal value for the calculated time offset. If the value is over this limit, the time syncing feature will be switched off. </summary>
        ...
        public const string ImplxRootFolderName = "implx";

        /// <summary> The default name used for the Implx configuration file. </summary>
        public const string ImplxDefaultConfigFilename = "implx.conf";
        ...
        public static void RegisterRules(IConsensus consensus)
        {
            ...
            consensus.ConsensusRules
                ...
                .Register<ImplxCoinviewRule>() // implements BIP68, MaxSigOps and BlockReward calculation
                                               // Place the PosColdStakingRule after the PosCoinviewRule to ensure that all input scripts have been evaluated
                                               // and that the "IsColdCoinStake" flag would have been set by the OP_CHECKCOLDSTAKEVERIFY opcode if applicable.
                .Register<ImplxColdStakingRule>()
        ...
        public static void RegisterMempoolRules(IConsensus consensus)
        {
            consensus.MempoolRules = new List<Type>()
            {
                ...
                typeof(ImplxCoinViewMempoolRule),
                typeof(CreateMempoolEntryMempoolRule),
                typeof(CheckSigOpsMempoolRule),
                typeof(ImplxTransactionFeeMempoolRule),
        ...
        public static Block CreateGenesisBlock(ConsensusFactory consensusFactory, uint time, uint nonce, uint bits, int version, Money genesisReward, string genesisText)
        {
            ...
            1. Create the template block as above in the CreateImplxGenesisBlock method
        ...
        {
            { NetworkType.Mainnet, Networks.Implx.Mainnet },
            { NetworkType.Testnet, Networks.Implx.Testnet },
            { NetworkType.Regtest, Networks.Implx.Regtest }
        };
    }
}
