    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            try
            {
                ...
                // set the console window title to identify this as a Implx full node (for clarity when running Implx and Cirrus on the same machine)
                Console.Title = "ImpleumX Full Node";
